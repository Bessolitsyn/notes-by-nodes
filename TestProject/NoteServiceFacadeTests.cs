...
namespace TestProject
{
    ...
    /// Компонент здесь это сервис заметокж тестируются некоторые (к сожалению не все, понятно, что нужно протестировать все варианты использования сервиса) 
    /// самые распространненые ваианты использования сервиса
    /// </summary>
